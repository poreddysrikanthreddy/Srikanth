...
import sty from "./PlasmicButton.module.css"; // plasmic-import: gV4dpx9Bvf5pu3/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: xjkQVYMXxJm_t5/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ka4tJuQDdu653J/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kki8Y)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__aXKtq)}
                role={"img"}
              />
            ),
